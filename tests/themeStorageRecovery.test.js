...
test('host-managed updates do not clean or reset source and preserve theme ignore rules', () => {
    ...
    assert.doesNotMatch(updateCommand, /clean -fd|reset --hard/)
    assert.match(updateCommand, /openclaw plugins update/)
})
