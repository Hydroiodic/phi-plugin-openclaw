...
export function createSettingsSchemas(includeCredentials = true) {
...
export function createSettingsForm(config, options = {}) {
    const items = shared.editable.filter(item => options.includeCredentials !== false || !item.generated)
    return {
        schemas: createSettingsSchemas(options.includeCredentials !== false),
        getConfigData() {
