...
export function setPlatformAdapter(adapter = {}) {
    // A full runtime replaces the previous instance, including its state and
    // prototype methods. Partial injection remains useful for isolated tests.
    if (adapter.PluginBase && adapter.redis && adapter.wrapEvent) {
